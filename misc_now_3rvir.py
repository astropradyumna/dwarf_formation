# This is mostly the same as the misc.py, but we are now using the data from the FoF folder that had data until 3rvir
...
star_pos = np.load(this_fof_path+'star_pos.npy') #fof0_merged_evolved_wmbp_everything kpc, wrt center of the fof halo
...
df.to_csv(outpath + fof_str + '_merged_evolved_wmbp_everything1.csv', index = False) 
